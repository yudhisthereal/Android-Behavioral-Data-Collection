...
import com.example.behavioraldatacollection.screens.monitoring.MonitoringScreen
import com.example.behavioraldatacollection.screens.typing.TypingScreen

@Composable
fun AppNavigation(navController: NavHostController, timerViewModel: TimerViewModel) {
    NavHost(navController = navController, startDestination = "home") {
        ...
        composable("monitoring") { MonitoringScreen(navController, timerViewModel) }
    }
}